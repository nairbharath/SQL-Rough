...
delete from locations where location_id=1400;
delete from locations where location_id=1500;
...
select * from employees where last_name like 'K%' order by last_name asc;
...
INSERT INTO
employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES
(207,'Paul','Newton','paul.newton@sqltutorial.org','515.128.2048','1996-06-07',1,8300.00,205,11);
